...
namespace weavess {
    ...
    public:
        ...
        struct Neighbor {
            ...
            float distance;
            bool flag;
            unsigned id_src; // for NSG_F, id is id_dst, id_src is the source id. TODO Parallel warning
            ...
            Neighbor(unsigned id, float distance, bool f, unsigned id_src) : id{id}, distance{distance}, flag(f), id_src(id_src) {}
...
//            }
    ...
    public:
        ...
        // typedef std::vector<std::map<unsigned, std::vector<SimpleNeighbor>> > InedgeCandidates;
        typedef std::vector<std::map<unsigned, std::vector<unsigned>> > InedgeCandidates;

        InedgeCandidates &getInedgeCandidates() {
            return inedge_candidates_;
        }
    ...
    private:
        ...
        InedgeCandidates inedge_candidates_;
