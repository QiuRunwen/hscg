...
namespace weavess {
    ...
    class ComponentInitLSHCS : public ComponentInit {
    public:
        explicit ComponentInitLSHCS(Index *index) : ComponentInit(index) {}
    ...
    private:
        ...
        void InitInnerColliCount();

        void build_hashtables(Eigen::Matrix<unsigned, Eigen::Dynamic, Eigen::Dynamic> &hash_tables);

        void build_one_hashtable(Eigen::Ref<Eigen::Vector<unsigned, Eigen::Dynamic>> hashtable);

        void get_cand_foreach(std::vector<std::map<unsigned, unsigned>> &candidate_list, const Eigen::Ref<Eigen::Vector<unsigned, Eigen::Dynamic>> hashtable);
    };
    ...
    class ComponentRefineNSGSphere2 : public ComponentRefine {
        public:
            explicit ComponentRefineNSGSphere2(Index *index) : ComponentRefine(index) {}
    ...
    class ComponentRefineNSG_LSHCS : public ComponentRefine {
    public:
        explicit ComponentRefineNSG_LSHCS(Index *index) : ComponentRefine(index) {}
    ...
    class ComponentRefineNSG_F : public ComponentRefine {
    public:
        explicit ComponentRefineNSG_F(Index *index) : ComponentRefine(index) {}
    ...
    class ComponentRefineEntryCentroidSphere : public ComponentRefineEntry {
    public:
        explicit ComponentRefineEntryCentroidSphere (Index *index) : ComponentRefineEntry(index) {}
    ...
    class ComponentRefineEntryCentroidSphere2 : public ComponentRefineEntry {
    public:
        explicit ComponentRefineEntryCentroidSphere2 (Index *index) : ComponentRefineEntry(index) {}
    ...
    class ComponentCandidateNSGSphere2 : public ComponentCandidate {
    public:
        explicit ComponentCandidateNSGSphere2(Index *index) : ComponentCandidate(index) {}
    ...
    class ComponentCandidateLSHCS : public ComponentCandidate {
        public:
            explicit ComponentCandidateLSHCS(Index *index) : ComponentCandidate(index) {}
    ...
    class ComponentConnNSGSphere2DFS : ComponentConn {
    public:
        explicit ComponentConnNSGSphere2DFS(Index *index) : ComponentConn(index) {}

        void ConnInner();

    private:
        void tree_grow(unsigned root);
    ...
    class ComponentSearchEntryCentroidSphere2 : public ComponentSearchEntry {
    public:
        explicit ComponentSearchEntryCentroidSphere2(Index *index) : ComponentSearchEntry(index) {}
    ...
    class ComponentSearchRouteLinearScan : public ComponentSearchRoute {
        public:
            explicit ComponentSearchRouteLinearScan(Index *index) : ComponentSearchRoute(index) {}
    ...
    class ComponentSearchRouteGreedyF : public ComponentSearchRoute {
    public:
        explicit ComponentSearchRouteGreedyF(Index *index) : ComponentSearchRoute(index) {}
